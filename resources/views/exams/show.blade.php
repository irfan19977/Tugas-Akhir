            ...
            <div class="card">
                ...
                <div class="card-body">
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item">Jumlah Soal : {{ $exam->total_question }} buah</li>
                        ...
                        @if (!is_null($userScore))
                            <li class="list-group-item">Nilai Ujian Anda : {{ $userScore }}</li>
                        @endif
                    </ul>
                </div>
                <div class="card-footer">
                    @if (now() > $exam->start && now()  < $exam->end)
                        ...
                        @else
                        <a onclick="goBack()" class="btn btn-danger btn-lg btn-block" role="button" aria-pressed="true">ANDA SUDAH MENGERJAKAN UJIAN - KEMBALI</a>
                        @endif
