        ...
        <div class="col-12">
          <div class="row justify-content-center">
            <div class="col-md-7 text-center hero-text">
              ...
              <p class="mb-5" data-aos="fade-up" data-aos-delay="100">Berikut merupakan profile sekolah SMK Wiyata Mandala</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="container">
      <div class="row align-items-center"  data-aos="fade-right">
        <div class="col-md-6 me-auto justify-text">
          ...
          <ul>
            <li class="mb-3">Alamat : Jl. Pare Kandangan No.1945, Kemirahan, Damarwulan, Kec. Kepung, Kabupaten Kediri, Jawa Timur 64293</li>
  ...
  <section class="section pb-0">
    <div class="container">
        <div class="row align-items-center justify-text">
            ...
            <div class="col-md-6" data-aos="fade-left" style="min-height: 220px;"> <!-- Sesuaikan tinggi minimum dengan kebutuhan -->
      ...
      <div class="row align-items-center"  data-aos="fade-right">
        <div class="col-md-12 me-auto justify-text">
          ...
          <p class="mb-4">Selamat datang di SMK Wiyata Mandala, sebuah lembaga pendidikan di Kabupaten Kediri 
            ...
            pusat pendidikan unggul, kami bertekad mencetak lulusan yang kompeten, berdaya saing, dan berakhlak mulia.
        </p>
        <p class="mb-4">Didirikan pada tahun 1988, SMK Wiyata Mandala telah menjadi bagian integral dari perkembangan 
        ...
        <p class="mb-4">Program pendidikan kami mencakup jurusan-jurusan yang relevan dengan tuntutan industri, 
            mempersiapkan siswa untuk menghadapi dunia kerja dengan keahlian yang dibutuhkan. Laboratorium modern, 
            perpustakaan lengkap, dan fasilitas pendukung lainnya memastikan pengalaman belajar yang komprehensif.
        </p>
        <p class="mb-4">Tidak hanya dalam kelas, kami juga menghargai pentingnya pengembangan karakter dan kegiatan 
            ekstrakurikuler. Pelatihan Tartil Qur’an, Pramuka, Fustal, Drum Band adalah sebagian dari beragam kegiatan 
